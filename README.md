...
## Hypothesis Testing  
**Null Hypothesis:** The distribution showcasing the percentage neutral objective control for teams who win is the same as the distribution showcasing the percentage neutral objective control for teams who lose.  
**Alternative Hypothesis:** The distribution showcasing the percentage neutral objective control for teams who win is different from the distribution showcasing the percentage neutral objective control for teams who lose, with teams who have higher percentage neutral objective control being more likely to win.  
**Test Statistic:** To test this, I will be using differences in group means as I want to see whether percentage neutral objective control is <mark>higher on average</mark> for teams who win, than for teams who lose.  
